...
config :demo_client_embed_phoenix_app,
  ecto_repos: [DemoClientEmbedPhoenixApp.Repo]
...
config :demo_client_embed_phoenix_app, DemoClientEmbedPhoenixAppWeb.Endpoint,
  ...
  live_view: [signing_salt: "z0hSm7O5"]
...
config :esbuild,
  ...
  default: [
    args:
      ~w(js/app.js js/app_embed.js --bundle --target=es2017 --outdir=../priv/static/assets --external:/fonts/* --external:/images/*),
